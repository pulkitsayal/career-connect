...
const JWT_SECRET = 'thecatwascute';
...
const save = () => update(users, posts, nextMessageId);
const reset = () => {
    update({}, {}, 1);
    users = {};
    posts = {};
...
const assertValidJobPost = (jobPostId) => dataLock((resolve, reject) => {
...
const getJobs = (authUserId, start) => dataLock((resolve, reject) => {
...
const postJob = (authUserId, image, title, start, description) => dataLock((resolve, reject) => {
...
const updateJobPost = (authUserId, jobPostId, image, title, start, description) => dataLock((resolve, reject) => {
...
const commentOnJobPost = (authUserId, jobPostId, comment) => dataLock((resolve, reject) => {
...
const likeJobPost = (authUserId, jobPostId, turnon) => dataLock((resolve, reject) => {
    if (turnon) {
...
const deleteJobPost = (authUserId, jobPostId) => dataLock((resolve, reject) => {
...
const getUser = (userId) => dataLock((resolve, reject) => {
...
const watchUser = (watcherUserId, watcheeUserId, turnon) => dataLock((resolve, reject) => {
    if (turnon === undefined) {
...
const updateProfile = (authUserId, email, password, name, image) => dataLock((resolve, reject) => {
...
module.exports = { InputError, AccessError, save, reset, assertValidUserId, getUserIdFromAuthorization,
    getUserIdFromEmail, authed, login, register,
    assertValidJobPost, assertCreatorOfJobPost, assertWatcherOfJobPost, getJobs,
    postJob, updateJobPost, commentOnJobPost, likeJobPost, deleteJobPost, getUser,
    watchUser, updateProfile
};
